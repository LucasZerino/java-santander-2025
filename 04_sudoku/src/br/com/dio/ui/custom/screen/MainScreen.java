...
import br.com.dio.service.NotifieService;
...
public class MainScreen {
    ...
    private final NotifieService notifierService;
    ...
    public MainScreen(final Map<String, String> gameConfig){
        ...
        this.notifierService = new NotifieService();
    }
    ...
    private void addFinishGameButton(JPanel mainPanel) {
        finishGameButton = new FinishGameButton( e-> {
           if(boardService.gameIsFinished()){
               ...
               JOptionPane.showMessageDialog(null, "Seu jogo contém algum erro, tente novamente!");
           }
        });
